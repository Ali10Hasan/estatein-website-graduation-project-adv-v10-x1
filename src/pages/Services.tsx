...
const Services = () => {
  return (
    <div className="bg-grey-08 light:bg-white-99 text-white light:text-grey-08">
      ...
      <div className="Site-Advatages-Container mt-[40px] mb-[60px] mx-[13px] md:mx-0 md:mt-[20px] flex flex-wrap gap-[10px] md:gap-[20px] items-center justify-start w-[calc(100%-26px)] md:w-full bg-grey-08 light:bg-white-99 p-[4px] md:p-[20px] rounded-[12px] md:rounded-[0px] shadow-[0px_0px_0px_4px_rgba(25,_25,_25,_1)] md:shadow-[0px_0px_0px_10px_rgba(25,_25,_25,_1)] light:shadow-[0px_0px_0px_4px_#F2F2F2] md:light:shadow-[0px_0px_0px_10px_#F2F2F2]">
        {cardAdvantagesData.map((item, index) => (
          <div
            key={index}
            className="w-[calc(50%-5px)] md:w-[calc(25%-15px)] h-[188px] bg-grey-10 light:bg-white-95 rounded-[12px]"
          >
            <CardAdvantages
              Arrow={item.Arrow}
              Icone={item.Icone}
