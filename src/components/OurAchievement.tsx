...
const OurAchievement = ({title , description} : OurAchievementProps) => {
  return (
    <div className="w-full rounded-xl border border-grey-15 p-24 min-[992px]:p-40 flex flex-col justify-start text-white bg-grey-08 ring-8 ring-grey-09 hover:bg-grey-15 transition-colors">
