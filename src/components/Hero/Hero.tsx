...
const Hero = () => {
    ...
    return (
        <section className="mx-auto w-full flex justify-center 2xl:max-w-1920 xl:gap-60 2xl:gap-80 2xl:pl-162 xl:pl-80 xl:flex-row flex-col-reverse px-16 lg:px-0 mt-40 xl:mt-0 overflow-hidden">
            <div className='w-full 2xl:max-w-758 xl:max-w-690 flex flex-col justify-center '>
                ...
                <div className='2xl:max-w-920 xl:max-w-610 mx-auto xl:mx-0'>
                    ...
                    <FadeUp delay={1.15} duration={0.7}>
            ...
            <FadeRight delay={0.3} duration={0.9} className="relative 2xl:max-w-920 bg-grey-10 light:bg-white-97 xl:max-w-690 rounded-xl border border-grey-15 light:border-white-90 mb-56 xl:mb-0 lg:rounded-none lg:border-0
            ...
            >
                ...
                <div className="absolute z-50 -bottom-45 2xl:w-175 xl:w-129 xl:top-95 2xl:top-144 xl:translate-x-[-50%] w-117">
                    <img src="/assets/imgs/heros/CircleHero.webp" alt="Circle" className='animate-spin  light:invert' style={{ animationDuration: '10s' }} />
                </div>
