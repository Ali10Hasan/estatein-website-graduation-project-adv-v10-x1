...
const AboutHero = ({ title, description, img }: IAboutHero) => {
    return (
        <section className="flex flex-col-reverse xl:grid xl:grid-cols-2 items-center justify-between xl:max-w-1296 2xl:max-w-1612 mx-auto px-16 bg-grey-08 sm:relative gap-56 xl:gap-60 2xl:gap-80 mt-50 xl:mt-70 2xl:mt-100 my-50 lg:my-70 xl:my-100 mb-80 xl:mb-120 2xl:mb-150">
