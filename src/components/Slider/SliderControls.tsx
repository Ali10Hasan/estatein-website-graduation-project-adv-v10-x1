    ...
    return (
        <div className={ fullWidth ? "flex items-center justify-between w-full md:w-auto md:justify-normal md:gap-10"
            ...
            <button
                ...
                <FaArrowLeft className="w-[14.4px] h-[14.4px] md:h-17 min-[1440px]:w-18 min-[1440px]:h-21" />
            </button>

            {showNumberBetween && (
                <div className="md:hidden text-grey-60 text-[14px] font-medium px-10 ">
            ...
            <button
                ...
                className="w-44 h-44 min-[1441px]:w-58 min-[1441px]:h-58 rounded-full border border-grey-15 bg-grey-10 text-white flex items-center justify-center transition-all">
                <FaArrowRight className="w-[14.4px] h-[14.4px] md:h-17 min-[1440px]:w-18 min-[1440px]:h-21" />
            </button>
        </div>
    );
}