  ...
  return (
    <div className="group w-full rounded-xl border border-grey-15 p-20 md:p-24 lg:p-30 h-full flex flex-col transition-colors duration-300 hover:border-purple-60">
      ...
      <div className="relative">
        ...
        <div className="overflow-hidden rounded-10">
          <img
            src={image}
            alt={name}
            className="w-full rounded-10 object-cover h-full transition-transform duration-500 ease-in-out group-hover:scale-105"
          />
        </div>
        ...
        >
          <FaTwitter
            className="size-20 lg:size-24 transition-transform duration-600 ease-in-out group-hover:rotate-[360deg]"
          />
        </button>
      ...
      <div className="mt-40 md:mt-50 mb-16 md:mb-20 lg:mb-24 text-center flex flex-col flex-1">
        <h3 className="font-urbanist text-xl lg:text-2xl font-semibold leading-24 text-white">
          {name}
        </h3>

        <p className="mt-2 md:mt-4 lg:mt-6 font-urbanist text-sm lg:text-lg font-medium leading-24 text-grey-60">
          {role}
        </p>
      </div>
