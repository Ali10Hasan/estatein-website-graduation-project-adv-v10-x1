...
<div className="min-[992px]:flex-3 bg-grey-08 ring-8 ring-grey-09 border border-grey-15 rounded-2xl p-10 grid grid-cols-1 min-[992px]:grid-cols-2">
  <div className="min-[992px]:border-r border-b min-[992px]:border-b min-[992px]:pb-0 border-grey-15 pb-20 min-[992px]:pr-20 rounded-tl-xl hover:bg-grey-15 transition-colors">
    <ValueCard {...VALUES_DATA[0]} />
  </div>
  <div className="border-b border-grey-15 pb-20 min-[992px]:pb-0 min-[992px]:pl-20 rounded-tr-xl hover:bg-grey-15 transition-colors">
    <ValueCard {...VALUES_DATA[1]} />
  </div>
  <div className="min-[992px]:border-r border-grey-15 pt-20 min-[992px]:pr-20 rounded-bl-xl hover:bg-grey-15 transition-colors">
    <ValueCard {...VALUES_DATA[2]} />
  </div>
  <div className="pt-20 min-[992px]:pl-20 rounded-br-xl hover:bg-grey-15 transition-colors">
