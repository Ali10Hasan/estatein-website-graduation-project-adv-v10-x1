    ...
    <section className="bg-grey-08 light:bg-white-99 text-white light:text-grey-08 font-urbanist w-full py-40 md:pt-80 md:pb-50">
      <Container>
        <div className="mb-30 md:mb-50 relative px-16 sm:px-0">
          ...
          <p className="text-grey-60 light:text-grey-40 text-[14px] sm:text-[16px] md:text-[18px] font-urbanist leading-[150%] max-w-[1296px] w-full block">
            {description}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-20 px-16 sm:px-0">
          ...
          <div
            className="relative overflow-hidden col-span-1 md:col-span-2 border border-grey-15 light:border-white-90 rounded-10 md:rounded-12 p-16 sm:p-30 lg:p-50 bg-grey-10 light:bg-white-95 flex flex-col justify-between gap-14 md:gap-20 bg-no-repeat bg-cover bg-right-bottom transition-all duration-300 hover:border-grey-30 light:hover:border-grey-40 mt-10 md:mt-0"
          ...
          >
            ...
            <p className="text-grey-60 light:text-grey-40 text-[14px] md:text-[16px] font-urbanist leading-[150%] relative z-10 max-w-[820px]">
              {bannerDescription}
            </p>
          </div>
        </div>
