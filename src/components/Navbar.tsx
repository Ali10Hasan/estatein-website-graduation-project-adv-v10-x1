...
const Navbar = () => {
  ...
  return (
    <nav className="bg-grey-10 light:bg-white-97">
      <div className="w-full max-w-1900 mx-auto px-16 md:px-40 lg:px-60 relative flex justify-between items-center py-20 font-medium text-18 text-white light:text-grey-10 gap-10">
